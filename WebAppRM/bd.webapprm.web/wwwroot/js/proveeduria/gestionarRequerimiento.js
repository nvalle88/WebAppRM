...
function CallbackFunctionCheckBoxArticulo(idRecepcionActivoFijoDetalle, seleccionado) {
    if (seleccionado) {
        ...
        addRowDetallesActivosFijos("tableDetallesRequerimientos", "tableDetallesArticulos", idRecepcionActivoFijoDetalle, [thClassName.nombreArticulo, thClassName.cantidad, thClassName.valorActual, thClassName.cantidadBodega, hIdRecepcionActivoFijoDetalle + btnEliminarArticulo], true);
