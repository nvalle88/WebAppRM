    ...
    public class TransferenciaActivoFijoController : Controller
    {
        ...
        public async Task<IActionResult> Create(TransferenciaActivoFijo TransferenciaActivoFijo)
        {
            ...
            try
            {
                ...
                if (response.IsSuccess)
                {
                    ...
                    var responseLog = await GuardarLogService.SaveLogEntry(new LogEntryTranfer
                    {
                        ...
                        ExceptionTrace = null,
                        Message = "Se ha creado una Transferencia de un Activo Fijo",
                        UserName = "Usuario 1",
                        LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
                        LogLevelShortName = Convert.ToString(LogLevelParameter.ADV),
                        EntityID = string.Format("{0} {1}", "TransferenciaActivoFijo:", TransferenciaActivoFijo.IdTransferenciaActivoFijo),
                    });
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppRM),
                    Message = "Creando TransferenciaActivoFijo",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Create),
        ...
        public async Task<IActionResult> Edit(string id, TransferenciaActivoFijo TransferenciaActivoFijo)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppRM),
                    Message = "Editando una Transferencia de Activo Fijo",
                    ExceptionTrace = ex,
                    LogCategoryParametre = Convert.ToString(LogCategoryParameter.Edit),
                    LogLevelShortName = Convert.ToString(LogLevelParameter.ERR),
                    UserName = "Usuario APP webappth"
        ...
        public async Task<IActionResult> Index()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    ApplicationName = Convert.ToString(Aplicacion.WebAppRM),
                    Message = "Listando transferencias de activos fijos",
                    ExceptionTrace = ex,
