...
namespace bd.webapprm.web.Controllers.MVC
{
    public class ProveeduriaController : Controller
    {
        ...
        public async Task<IActionResult> ProveeduriaReporteAltas()
        {
            ...
            try
            {
                articulos = await apiServicio.Listar<RecepcionArticulos>(new Uri(WebApp.BaseAddress)
                                                                    , "/api/RecepcionArticulos/ListarRecepcionArticulos");
                altas = await apiServicio.Listar< AltaProveeduria >(new Uri(WebApp.BaseAddress)
        ...
        public async Task<IActionResult> ProveeduriaReporteBajas()
        {
            ...
            try
            {
                articulos = await apiServicio.Listar<RecepcionArticulos>(new Uri(WebApp.BaseAddress)
                                                                    , "/api/RecepcionArticulos/ListarRecepcionArticulos");
                bajas = await apiServicio.Listar<AltaProveeduria>(new Uri(WebApp.BaseAddress)
        ...
        public async Task<IActionResult> MinMaxReporte()
        {
            ...
            try
            {
                articulos = await apiServicio.Listar<RecepcionArticulos>(new Uri(WebApp.BaseAddress)
                                                                    , "/api/RecepcionArticulos/ListarRecepcionArticulos");
                solic = await apiServicio.Listar<SolicitudProveduriaDetalle>(new Uri(WebApp.BaseAddress)
                                                                    , "/api/SolicitudProveduriaDetalle/ListarSolicitudProveeduriasDetalle");
