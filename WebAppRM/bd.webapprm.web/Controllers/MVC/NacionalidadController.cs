...
namespace bd.webapprm.web.Controllers.MVC
{
    public class NacionalidadController : Controller
    {
        ...
        public NacionalidadController(IApiServicio apiServicio)
        {
        ...
        public async Task<IActionResult> Create(Nacionalidad Nacionalidad)
        {
            ...
            try
            {
                response = await apiServicio.InsertarAsync(Nacionalidad,
                                                             ...
                                                             "/api/Nacionalidad/InsertarNacionalidad");
        ...
        public async Task<IActionResult> Edit(string id, Nacionalidad Nacionalidad)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(id))
                {
                    response = await apiServicio.EditarAsync(id, Nacionalidad, new Uri(WebApp.BaseAddressRM),
                                                                 "/api/Nacionalidad");
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                lista = await apiServicio.Listar<Nacionalidad>(new Uri(WebApp.BaseAddressRM)
                                                                    , "/api/Nacionalidad/ListarNacionalidades");
                return View(lista);
            }
            catch (Exception ex)
            {
